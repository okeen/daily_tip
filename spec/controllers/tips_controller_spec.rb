  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tip" do
        ...
        Tip.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => tip.to_param, :tip => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tip as @tip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tip.any_instance.stub(:save).and_return(false)
        put :update, {:id => tip.to_param, :tip => {}}, valid_session
        assigns(:tip).should eq(tip)
      end
